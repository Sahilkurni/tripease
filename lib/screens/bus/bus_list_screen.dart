...
class BusListScreen extends StatefulWidget {
  ...
  const BusListScreen({super.key, this.source, this.destination, this.date});
...
class _BusListScreenState extends State<BusListScreen> {
  ...
  void initState() {
    ...
    _selectedDestination =
        widget.destination == 'Destination' ? null : widget.destination;
    _fetchBuses();
  }
    ...
    List<BusModel> filteredBuses =
        _buses.where((bus) {
          final matchesSearch =
              ...
              bus.sourceCityName.toLowerCase().contains(
                _searchQuery.toLowerCase(),
              ) ||
              bus.destinationCityName.toLowerCase().contains(
                _searchQuery.toLowerCase(),
              );

          final matchesSource =
              _selectedSource == null || bus.sourceCityName == _selectedSource;
          final matchesDest =
              _selectedDestination == null ||
              bus.destinationCityName == _selectedDestination;
  ...
  Widget _buildGrid(BuildContext context, bool isDark) {
    return GridView.builder(
      ...
      itemBuilder:
          (context, index) => _BusTripCard(bus: _buses[index], isDark: isDark),
    );
  }
          ...
          Row(
            ...
            children: [
              _buildTimeLoc(
                ...
                bus.sourceCityName.isNotEmpty ? bus.sourceCityName : 'Source',
                false,
              ),
              const Icon(
              ...
              _buildTimeLoc(
                ...
                bus.destinationCityName.isNotEmpty
                    ? bus.destinationCityName
                    : 'Destination',
                true,
              ),
            ],
  ...
  Widget _buildTimeLoc(String time, String loc, bool alignEnd) {
    return Column(
      ...
      children: [
        ...
        Text(loc, style: GoogleFonts.poppins(color: Colors.grey, fontSize: 12)),
      ],
    );
  }
